...
function maskequip(mask) 
	...
	local ohTable2 = { ["Mute"] = false, ["Type"] = mask, ["Category"] = "Accessory"} game:GetService("ReplicatedStorage").Events.ItemPackageEvent:InvokeServer(ohString1, ohTable2) 
end
...
local Config = { WindowName = "🌌  andromedead | "..temptable.version, Color = Color3.fromRGB(255, 184, 65), Keybind = Enum.KeyCode.Semicolon}
...
information:CreateLabel("The source code of Kocmoc by weuz_ was taken as a basis")
